...
KarelRepeat.prototype.compile = function(vm, exp, code, fnName) {
   var temp = "$" + fnName + vm.nextTemp++;
...
KarelBlock.prototype.compile = function(vm, exp, code, fnName) {
   for (var i = 1; i < exp.length; i++) {
      vm.compile(exp[i], code, fnName);
   }
};
